...
describe('The Legend component', function () {
  beforeEach(function () {
    ...
    this.useDocumentRenderer = function (props) {
      var domComponent = _reactAddonsTestUtils["default"].renderIntoDocument(_react["default"].createElement("div", null, getLegend(props)));
  ...
  it('creates at least one li, selected by default, using the props.selectedLabel', function () {
    ...
    expect(this.renderedComponent.props.children[0]).toEqual(_react["default"].createElement("li", {
