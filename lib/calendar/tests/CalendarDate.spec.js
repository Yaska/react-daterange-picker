...
describe('The CalendarDate Component', function () {
  ...
  beforeEach(function () {
    ...
    var getCalendarDate = function getCalendarDate(props) {
      ...
      return _react["default"].createElement(_CalendarDate["default"], props);
    };
    ...
    this.useDocumentRenderer = function (props) {
      var renderedTable = _reactAddonsTestUtils["default"].renderIntoDocument(_react["default"].createElement("table", null, _react["default"].createElement("tbody", null, _react["default"].createElement("tr", null, getCalendarDate(props)))));
  ...
  describe('handles half days', function () {
    it('by creating calendar date period when there is more than one period', function () {
      ...
      expect(this.renderedComponent.props.children[0]).toEqual(_react["default"].createElement("div", {
    ...
    it('by creating a simple div when there is only one period', function () {
      ...
      expect(this.renderedComponent.props.children[1]).toEqual(_react["default"].createElement("div", {
  ...
  describe('has a selection widget', function () {
    it('with a modifier prop of single if props.isSelectedDate is true and others false', function () {
      ...
      expect(this.renderedComponent.props.children[3]).toEqual(_react["default"].createElement(_CalendarSelection["default"], {
        modifier: "single",
        pending: false
      }));
    });
  ...
  describe('has a highlight modifier', function () {
    it('which shows when props.isHighlightedDate is true', function () {
      ...
      expect(this.renderedComponent.props.children[4]).toEqual(_react["default"].createElement(_CalendarHighlight["default"], {
        modifier: "single"
      }));
    });
    it('which does not show otherwise', function () {
