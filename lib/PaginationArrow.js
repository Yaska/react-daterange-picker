...
function (_BemMixin) {
  ...
  function PaginationArrow() {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(PaginationArrow).apply(this, arguments));
  }

  _createClass(PaginationArrow, [{
    ...
    value: function render() {
      var _this$props = this.props,
          ...
          props = _objectWithoutProperties(_this$props, ["disabled", "direction", "onTrigger"]);
